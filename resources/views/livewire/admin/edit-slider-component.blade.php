<div>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Admin / Edit Slider</h1>
        ...
        <div class="col-md-11 mb-4">
            <div class="card shadow p-2">
                <div class="card-body">
                    ...
                    @endif
                    <form wire:submit.prevent="editSlider" class="p-2">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control-file" name="slider_image" wire:model="newImage">
                            @if ($newImage)
                                <img src="{{$newImage->temporaryUrl()}}" alt="Img" width="50px" height="50px">
                            @else
                                <img src="{{asset('assets/slide/'.$slider_image)}}" alt="Img" width="50px" height="50px">
                            @endif
                        </div>
                        
                        <button type="submit" class="btn btn-primary bg-gradient-primary">Update Slider</button>
                    </form>
                </div>
            </div>
        </div>
