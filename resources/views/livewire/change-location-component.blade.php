<div>
    ...
    <div class="content-central">
        <div class="semiboxshadow text-center">
            <img src="{{asset('assets/img/img-theme/shp.png')}}" class="img-responsive" alt="Logo">
        </div>
                                ...
                                <aside class="addlocation">
                                    ...
                                    <address>
                                        <div class="form-group">
                                            <label for="streetnumber" class="col-form-label">Street/Area Name:</label>
                                            <input type="text" class="form-control" id="street_name"
                                                name="street_name" wire:model="street_name">
                                        </div>
                                        <div class="form-group">
                                            <label for="landmark" class="col-form-label">Road/Landmark:</label>
                                            <input type="text" class="form-control" id="route" name="landmark" wire:model="landmark">
                                        </div>
                                        <div class="form-group">
