...
<body>
    <div id="layout">
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            ...
                            <li><a href="javascript:void(0)"><i class="fa fa-map-marker"></i> Mira Road, Mumbai</a></li>
                        </ul>
                    </div> --}}
                </div>
            </div>
        ...
        {{-- <div class="whatsappChat">
            <a href="#">
                <img src="{{asset('assets/images/watsup.png')}}" alt="whatsappLogo" height="40px" width="60px">
            </a>
        </div> --}}
