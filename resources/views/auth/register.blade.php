                ...
                <div class="card shadow p-3">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="role_as" name="role_as" required autofocus style="height: 35px">
                                            <option selected>Select Role</option>
                                            <option value="CST">User</option>
                            ...
                            <button type="submit" class="btn btn-dark bg-gradient-dark">Register</button>
                          </form>
                    </div>
                </div>
            </div>
    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="phone" class="block mt-1 w-full" type="text" name="phone" autocomplete="new-phone" />
            </div>

            <div class="mt-4">
                <x-jet-label for="role_type" value="{{ __('Role') }}" />
                <select id="role_type"  class="block mt-1 w-full" name="role_type">
                    <option value="CST" >
                        User
                    </option>
                    <option value="SP">
